...
const OwnerExpensesPage = lazyNamedPage(() => import('../pages/owner/OwnerExpensesPage'), 'OwnerExpensesPage')
...
const OwnerContactPage = lazyNamedPage(() => import('../pages/owner/OwnerContactPage'), 'OwnerContactPage')
    ...
    <Routes>
      ...
      <Route element={<OwnerProtectedRoute />}>
        <Route element={<OwnerLayout />}>
          ...
          <Route path={ROUTES.ownerExpenses} element={<OwnerExpensesPage />} />
          ...
          <Route path={ROUTES.ownerContact} element={<OwnerContactPage />} />
