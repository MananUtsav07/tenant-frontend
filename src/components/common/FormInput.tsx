...
export function FormInput(props: FormInputProps) {
  const { label, error, variant = 'light', hint, hideLabel, leadingIcon, trailingAdornment, wrapperClassName, ...rest } = props
  const id = (rest as InputHTMLAttributes<HTMLInputElement>).id
  const required = (rest as InputHTMLAttributes<HTMLInputElement>).required
